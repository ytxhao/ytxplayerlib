...
rm -rf mosquitto-2.0.12

tar -xzvf mosquitto-2.0.12.tar.gz

cd mosquitto-2.0.12

patch -p1 < ../mosquitto.patch
...
# cmake -DCMAKE_TOOLCHAIN_FILE=../../arm_linux_setup.cmake -Dtgt=${CMAKE_TARGET} -DCMAKE_INSTALL_PREFIX=${PREFIX} -DCMAKE_PREFIX_PATH=${PREFIX} ..
cmake -DCMAKE_TOOLCHAIN_FILE=../../arm_linux_setup.cmake -Dtgt=${CMAKE_TARGET} -DCMAKE_INSTALL_PREFIX=${PREFIX} -DCMAKE_PREFIX_PATH=${PREFIX} -DANDROID=YES ..
