...
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/$(libpaho-mqtt3_lib_path)
LOCAL_C_INCLUDES:= $(libpaho-mqtt3_c_includes) \
$(LOCAL_PATH)/../../../../../../build/output/jniLibs/armeabi-v7a/include
LOCAL_CFLAGS += -DOPENSSL
LOCAL_LDLIBS += -z -lpthread -lssl -lcrypto
# LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../../../../build/output/jniLibs/armeabi-v7a/include
LOCAL_LDFLAGS += $(LOCAL_PATH)/../../../../../../build/output/jniLibs/armeabi-v7a/lib/libssl.a \
                 $(LOCAL_PATH)/../../../../../../build/output/jniLibs/armeabi-v7a/lib/libcrypto.a 
