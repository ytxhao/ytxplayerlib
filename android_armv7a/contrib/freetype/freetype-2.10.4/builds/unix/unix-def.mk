...
REQUIRES_PRIVATE   := harfbuzz >= 1.8.0
LIBS_PRIVATE       := -lz -L/shared/ytxplayerlib/ytxPlayer/android/contrib/jni/jniLibs/armeabi-v7a/lib -lpng16
LIBSSTATIC_CONFIG  := -lfreetype -lz -L/shared/ytxplayerlib/ytxPlayer/android/contrib/jni/jniLibs/armeabi-v7a/lib -lpng16 -L/shared/ytxplayerlib/ytxPlayer/android/contrib/jni/jniLibs/armeabi-v7a/lib -lharfbuzz -lm -lfreetype -lz -lpng16 -lz -lm
build_libtool_libs := 
ft_version         := 23.4.17
